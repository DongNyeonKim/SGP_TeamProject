//
//  AllMapwithAddrViewController.swift
...
class AllMapwithAddrViewController: UIViewController, MKMapViewDelegate {
    ...
    func loadInitialData() {
        for post in posts {
            let statNm = (post as AnyObject).value(forKey: "csNm") as! NSString as String
            ...
            let YPos = (post as AnyObject).value(forKey: "longi") as! NSString as String
    ...
    override func viewDidLoad() {
        ...
        loadInitialData()
        let lat = stations[0].coordinate.latitude
        let lon = stations[0].coordinate.longitude
